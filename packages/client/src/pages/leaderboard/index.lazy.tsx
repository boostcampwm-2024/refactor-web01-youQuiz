...
import TopPlayer from './ui/TopPlayer';
import PlayerList from './ui/PlayerList';
import ConfettiBackground from './ui/ConfettiBackground';
...
export default function LeaderboardLazyPage() {
  const { pinCode } = useParams();

  const socket = getQuizSocket();
  const { data } = useLeaderboard(socket, pinCode ?? '');
